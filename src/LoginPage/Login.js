...
import { SendUserToDatabase } from './HelperFunctions/StoreinDB';
const Login = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const customer = new CustomerModel(customerName,customerEmail, customerPassword);
    SendUserToDatabase(customer);
  };
  return (
    <>
    ...
    <div className={`container ${isSignUp ? 'active' : ''}`} class="container" id="container">
        <div class="form-container sign-up">
            <form onSubmit={handleSubmit} >
                ...
                <input type="password" placeholder="Password" onChange={event=>setCustomerPassword(event.target.value)}/>
